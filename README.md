...
6. [Setup ssh with private key and public key instead of password](./Notes/remote-access.md#ssh-without-password)
7. [Install Pi Camera, preview, take picture, take video](./Notes/camera.md)
...
15. [File Transfer with SCP/SFTP](./Notes/FileTransfer.md)
